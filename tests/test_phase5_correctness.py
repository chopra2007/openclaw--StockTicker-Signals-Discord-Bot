...
async def test_c19_has_market_cap_fails_closed_on_error(monkeypatch):
    ...
    assert await social._has_market_cap("XYZ") is False, "must fail CLOSED on error"
