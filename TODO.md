...
## 51. Show a stock's expected move for the day or the week — DONE 2026-08-15

**File:** `em_command.md`

Let users type `!em SPY` for the options market's expected up/down range for the day (or the next session if the market has closed) and `!emw SPY` for the week ahead, shown as a detailed embed with a candlestick chart.
...
## 67. Finish the feature-idea sweep, reusing the already-saved codebase map — 13 of 14 switch decisions resolved 2026-08-16
...
## 81. Show the day-to-day change of the VVIX fear-of-fear gauge, not just the level — DONE 2026-08-16
...
## 82. Fix `!scan`'s news section: stale earnings block fresh news, and upcoming earnings never show — DONE 2026-08-16
...
## 103. Test whether a big early-morning stock move snaps back or keeps going — DONE 2026-08-28 (rejected: no edge found)
