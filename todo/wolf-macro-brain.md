...
**Status:** phase-1 + phase-2 + phase-3 + **phase-4 ALL LIVE in #news** (phase-4 went live 2026-06-02, user "go fully live"). Phase-4 = beneficiary inference (#2) + fixes #3/#4/#5. NEXT: wire confluence into !all; phase-3/4 follow-ups (1-month RS horizon, large RS deltas — see phase-4 section). Asset-direction convention: DONE (verified 2026-06-05; RE-VERIFIED accurate 2026-06-06 Wave 8 — macro_universe.yaml has `reviewed_at: "2026-06-02"`, the header comments state the convention explicitly (OIL bull = oil rising; YIELDS bull = yields rising; DXY bull = dollar strengthening), and the BONDS block is an explicit inverse alias of YIELDS — claim stands).
**Created:** 2026-05-31
