...
**Status:** phase-1 + phase-2 + phase-3 + **phase-4 ALL LIVE in #news** (phase-4 went live 2026-06-02, user "go fully live"). Phase-4 = beneficiary inference (#2) + fixes #3/#4/#5. NEXT: wire confluence into !all; phase-3/4 follow-ups (1-month RS horizon, asset-direction convention, large RS deltas — see phase-4 section).
**Created:** 2026-05-31
...
- **Phase-4 follow-ups (tracked):** 1-month RS is a known short-term-reversal horizon (tunable post-shadow-run; 63d was the research/Codex rec); macro_universe asset-direction convention (bull=up) to confirm during shadow review; sanity-check the large RS deltas (50-80pp for momentum names); shorts side + spike-RS guard deferred to v1.1; widen confluence/flow inputs later.
