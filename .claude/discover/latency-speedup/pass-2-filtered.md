...
| C4 2-stage embed | **OUT (follow-up)** | Helps *perceived* latency only; typical case is already ~36s with synthesis just ~5s. Adds Discord-edit/vault complexity. Revisit only if the typical case stays slow after C1. | [WONTFIX 2026-06-06 — progressive/2-stage embed KILLED by user, do not build]
...
- **C4 2-stage embed** — deferred (see above). [WONTFIX 2026-06-06 — progressive/2-stage embed KILLED by user, do not build]
